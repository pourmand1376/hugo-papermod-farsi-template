...
متولد سال ۱۳۷۶ هستم. در دوره متوسطه ریاضی فیزیک خوندم و سال ۱۳۹۵ از دبیرستان نمونه دولتی ملک ثابت (واقع در یزد) فارغ التحصیل شدم و همون سال در دانشکده مهندسی کامپیوتر دانشگاه یزد به ادامه تحصیل پرداختم. 

از همان ابتدا در کنار تحصیل، در شرکت نرم‌افزاری آماپردازش ایساتیس (سپند) مشغول به کار شدم و روی پروژه‌های مختلفی روی DotNet Framework کار کردم. روی پروژه‌های متنوعی هم کار کردم: از گزارش‌ساز پویا StimulReport تا بهینه‌سازی کوئری‌های SQL-Server تا اتصال به کلی دستگاه پوز و ترازو و وب‌سرویس پیامکی. اواخر کارم هم یک Restful API برای نرم‌افزار اندروید توسعه دادم و الان هم به خوبی کار می‌کنه.  
...
در اوقات فراغت روی پروژه های متن باز در [Github](https://github.com/pourmand1376) مشارکت می‌کنم و در [Kaggle](kaggle.com/amirpourmand) هم فعالیت هایی داشتم و دارم.
...
فعلا (مثل بقیه همسن و سال‌هام) در هیچ زمینه‌ای متخصص نیستم. یه دانشجوی ساده هوش مصنوعی‌ام و به رشته‌ام علاقه مندم. همچنین به MBA بسیار علاقه‌مندم و از طریق [سایت متمم](https://motamem.org/profile/127223/) دارم دارم یه چیزهایی رو در موردش یاد می‌گیرم. 
