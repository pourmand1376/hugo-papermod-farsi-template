...
تو این مرحله تعداد سؤال جواب‌هایی که لازمه در حد چند میلیون خواهد بود. چیزهایی شبیه این: 

![](alpaca-sample.png)
![](alpaca-sample2.png)
منبع: [yahma/alpaca-cleaned · Datasets at Hugging Face](https://huggingface.co/datasets/yahma/alpaca-cleaned)

خیلی هم خوب یاد می‌گیره و الان مدلی داریم که می‌تونه به سؤالاتمون (ما بهش میگیم دستورات‌مون) جواب بده. 
...
فکر می‌کنم هممون همچین حسی داشتیم که این که صرفاً بشینیم یک چیزی رو حفظ کنیم، به درد هیچی نمی‌خوره و خب الان می‌بینیم کامپیوتر به این مرحله رسیده. 
...
فکر می‌کنم برای امروز زیاد شد. ادامه این پست، دو تا پست باید بنویسم. یکی راجع به روش‌های متن‌باز و چگونگی توسعه‌شون و دیگری راجع به این که چطوری آدم‌ها، مدل‌های زبانی بزرگ رو (که بنا به استعاره من، صرفاً دانشگاه رفتند و مطلب حفظ کردند) می‌تونند برای کسب و کارهای خودشون استفاده بکنند. 
