...
- نظر بسیار شخصی: ترجیحاً برای حمل‌ونقل به سرویس‌های باربری اعتماد نکنید. بارها تجربه داشتم که اول یک مبلغ رو توافق کرده‌بودیم و بعداً گفتند که نه! این مبلغ برای فلان چیز بود. هزینه فلان چیز جدا هست. با توجه به این‌که معمولا هزینه جابه‌جایی عدد کمی نیست یا روی قرارداد کتبی اصرار کنید (که معمولاً زیربار نمیرن) یا از سرویس‌های آنلاین (مثل خدمت‌ازما و آچاره یا هر چی صلاح می‌دونید) استفاده کنید. 
