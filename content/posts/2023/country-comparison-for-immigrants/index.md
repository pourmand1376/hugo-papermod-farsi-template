---
title: "مقایسه کشورها از نظر یک مهاجر ایرانی"
date: 2023-02-01
fatags: ["مهاجرت", "اپلای"]
---
...
- کانادا خیلی بهتر اروپاست. اروپا عملا روستاس. 
...
کشورهای امتیازی مثل کانادا و آمریکا هم معمولا می‌تونید یه تخمین داشته باشید که با توجه به **شرایط شما** چقدر طول خواهد کشید که بهتون ویزا بدند. مثلا اگر بخواید کار کنید، تو کانادا بعد از ۲ ۳ سال کار معمولا امتیاز مناسبی می‌گیرید. توی آمریکا هم میشه بعد چند سال کار در ریسرچ (با بدست آوردن citation) برای NIW اقدام کرد و گرین کارت (همون اقامت دائم) دریافت کرد. ([+](https://www.chaolaw.com/niw-citations.html) و [+](https://www.uscis.gov/green-card)).
...
فکر می‌کنم یه مسئله که به شدت با «گرم بودن و معاشرتی بودن» مردم ارتباط داره، آب و هوا هست. انگار تو آب و هوای گرم مردم گرم‌ترند! داخل ایران هم میشه دید. مثلا اهوازی‌ها مردم خیلی مهمون‌نواز و اجتماعی‌ای هستند یا مثلا مکزیکی‌ها به نظر آدم‌های اجتماعی‌تری میان. از طرفی سوئدی‌ها نسبتا سردترن.
...
تقریبا همه کشورها شرایطی رو در نظر می‌گیرند که افراد خانواده بتونند دوباره در کنار هم جمع بشن به این فرآیند اصطلاحا Family Reunification میگن و به این نوع ویزا، ویزای همراه یا ویزای پیوست (به خانواده) - Dependent via - هم میگن. معمولا این ویزا برای این به کار میره که همسرتون (یا فرزندان‌تون) بتونن همراه‌تون به کشور مقصد بیان.

 سوالات مهمی اینجا وجود داره: 
- آیا ویزای همراه همزمان با ویزای کاری (یا تحصیلی) شما صادر میشه؟ 
- اجازه کار به همراه داده میشه یا نه؟
- چقدر طول می‌کشه تا ویزای همراه صادر بشه؟
- آیا لزوما دو نفر باید ازدواج کرده باشند؟ 

قاعدتا فرآیند درخواست ویزا برای شما و همسرتون جداگانه خواهد بود. پس ممکنه ویزاهاتون با اختلاف زمانی صادر بشه. حالا بحث اینه که این تفاوت انقدری هست که مجبور بشه یکی بلیط هواپیما بگیره و بره و دیگری بعدا اضافه بشه؟

مشکل اینجا وقتی پیش میاد که بعضی کشورها میگن که توی درخواست ویزای پارتنر باید آدرس خونه همسرش قید بشه. بعد چون ما معمولا حساب بانکی هم نداریم نمی‌تونیم از دور خونه بگیریم. اینه که مجبوره اول همسر بره خونه رو بگیره. بعد برای ویزای همراه اقدام کنند. 
...
معمولا تو کشورهای اروپایی با ویزای همراه (چه کاری باشه چه تحصیلی)، میشه کار کرد به شرطی که برای PhD برید. علتش هم اینه که دکترا در خیلی کشورهای اروپایی، شغل حساب می‌شه و شما عملا کارمند دانشگاه هستید و Salary (حقوق) می‌گیرید (نه Scholarship و نه Grant). البته کارشناسی (bachelor) و ارشد (master) جایی شغل حساب نمیشن و به این دلیل بعید می‌دونم همراه مجوز کار داشته باشه. این مورد رو در قسمت سوم بیشتر توضیح میدم. 
