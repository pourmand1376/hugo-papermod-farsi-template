...
یه سری سوال الگوریتم هم داخل سایت [LeetCode](https://leetcode.com/problem-list/top-interview-questions) حل کردم. سایت خیلی خوبی هست. فکر می‌کنم تو زمینه الگوریتم حتی از سایتی مثل [GeeksForGeeks](https://www.geeksforgeeks.org/) هم بهتر عمل کرده. یه سری سوالاتی که حل کردم رو [اینجا](https://github.com/pourmand1376/LeetCodes) گذاشتم. 
...
مصاحبه های متنوعی رفتم و اکثرا سطح من رو mid-level ارزیابی کردند. 
...
### اجایل (چابک)
[[روش اجایل Agile یا چابک در مدیریت پروژه]]

خیلی به روش اجایل علاقه‌مند شدم. با شعار «اجایل رو باید اجایل یاد گرفت» رفتم جلو. 

به نظرم تفکر به شیوه چابک بسیار می‌تونه کمک‌کننده باشه و ما رو از دست برنامه‌ریزی‌های طولانی مدت به درد نخور راحت‌ کنه. منظورم همون مدل برنامه‌ریزی‌هایی هست که تو دوران مدرسه برامون میاوردن که انجام بدیم. مشاوران مدرسه هم سعی می‌کردند به نوعی کل هفته ما رو با درس پر کنند. 
...
البته به نظر میاد اجایل یک اسم جدید برای مفهوم قدیمی هست. ما شعرش رو هم داریم:
تو پای به راه نه و هیچ مپرس 
خود راه بگویدت که چون باید رفت

### باز هم مدیریت منابع

ماه قبل هم فایل سوم مدیریت منابع رو گوش داده بودم. ولی راستش نفهمیده بودم محمدرضا چی میگه. الان فهمیدم اصل بحث چیه. اصل بحث اینه که منابع رو «خام‌ فروشی» نکنیم و پرورش بدیم. خام فروشی فقط تو سطح کشور برای نفت و بنزین تعریف نمیشه. برای من به عنوان یک فرد هم تعریف میشه. 
...
یه مطلب خیلی خوب هم در متمم مطالعه کردم. 
...
فکر کنم خیلی حرف زدم. امیدوارم سرتون درد نیومده باشه :) 