...
طبق یه قاعده کلی اون‌هایی که تو دوره دکترا حقوق میدن، مدت زمان تحصیل رو هم کار حساب می‌کنند ولی اونهایی که بورسیه میدن نه. به نوعی براشون مهمه که مالیات ماهیانه پرداخت کنید. البته این تفاوت‌ها فقط برای دکترا صادق هست. من ندیدم جایی کارشناسی (‌‌Bachelor) یا مستر (Master) رو کار حساب کنند و شما تو مدت ارشد صرفا دانشجو هستید و جزو اقامت حساب نمیشه. 
...
شهروند اتحادیه اروپا رو با EU Citizen می‌شناسند. یک فایده‌اش اینه که ویزای شینگن می‌گیرید و می‌تونید بدون منتظر شدن برای ویزا و این چیزا تو اکثر کشورهای اروپایی سفر کنید. 
...
۲- آب و هوا
۳- فاصله از ایران
۴- ویزای همراه (همزمان + اجازه کار)
...
نوشتن در مورد این معیارها بیشتر برای ساختاردهی به ذهن جهت تصمیم‌گیری بوده. نهایتا بعضی از این معیارها برای من کمترین اهمیتی نداره ولی خب معرفی‌شون مهمه چون با توجه به شرایط ممکنه برای یک نفر اتفاقا اولویت اول باشه. 
...
گوگل، دوست ماست. اگر راجع به هر کشور جستجو کنید می‌تونید به سادگی اطلاعات مهمی راجع به معیارهایی که گفتم بدست بیارید. 
